...
public class CropImageOptions implements Parcelable {
   ...
   */
    ...
    /**
     * the title of the {@link com.oguogu.cropper.CropImageActivity}
     */
    ...
    public CropImageOptions() {
        ...
        circleSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, dm);

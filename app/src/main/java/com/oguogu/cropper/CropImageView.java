...
import com.oguogu.R;
import com.oguogu.cropper.*;
import com.oguogu.cropper.BitmapCroppingWorkerTask;
import com.oguogu.cropper.BitmapLoadingWorkerTask;
import com.oguogu.cropper.BitmapUtils;
import com.oguogu.cropper.CropImageAnimation;
import com.oguogu.cropper.CropImageOptions;
...
public class CropImageView extends FrameLayout {
     ...
     */
    private com.oguogu.cropper.CropImageAnimation mAnimation;
     ...
     */
    private WeakReference<com.oguogu.cropper.BitmapLoadingWorkerTask> mBitmapLoadingWorkerTask;

    /**
     * Task used to crop bitmap async from UI thread
     */
    private WeakReference<com.oguogu.cropper.BitmapCroppingWorkerTask> mBitmapCroppingWorkerTask;
    //endregion
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        com.oguogu.cropper.CropImageOptions options = null;
        Intent intent = context instanceof Activity ? ((Activity) context).getIntent() : null;
        if (intent != null) {
            options = intent.getParcelableExtra(com.oguogu.cropper.CropImage.CROP_IMAGE_EXTRA_OPTIONS);
        }
    ...
    public Rect getCropRect() {
        if (mBitmap != null) {
            ...
            return com.oguogu.cropper.BitmapUtils.getRectFromPoints(points, orgWidth, orgHeight,
    ...
    public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
        ...
        if (mBitmap != null) {
            ...
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                int orgWidth = mBitmap.getWidth() * mLoadedSampleSize;
                int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
                com.oguogu.cropper.BitmapUtils.BitmapSampled bitmapSampled =
                        com.oguogu.cropper.BitmapUtils.cropBitmap(getContext(), mLoadedImageUri, getCropPoints(),
                                mDegreesRotated, orgWidth, orgHeight,
                                mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                                reqWidth, reqHeight);
                croppedBitmap = bitmapSampled.bitmap;
            } else {
                croppedBitmap = com.oguogu.cropper.BitmapUtils.cropBitmap(mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY());
            }

            croppedBitmap = com.oguogu.cropper.BitmapUtils.resizeBitmap(croppedBitmap, reqWidth, reqHeight, options);
        }
    ...
    public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
        ...
        if (bitmap != null && exif != null) {
            com.oguogu.cropper.BitmapUtils.RotateBitmapResult result = com.oguogu.cropper.BitmapUtils.rotateBitmapByExif(bitmap, exif);
    ...
    public void setImageUriAsync(Uri uri) {
        if (uri != null) {
            com.oguogu.cropper.BitmapLoadingWorkerTask currentTask = mBitmapLoadingWorkerTask != null ? mBitmapLoadingWorkerTask.get() : null;
            if (currentTask != null) {
            ...
            clearImageInt();
            mCropOverlayView.setInitialCropWindowRect(null);
            mBitmapLoadingWorkerTask = new WeakReference<>(new com.oguogu.cropper.BitmapLoadingWorkerTask(this, uri));
    ...
    public void rotateImage(int degrees) {
        if (mBitmap != null) {
            ...
            com.oguogu.cropper.BitmapUtils.RECT.set(mCropOverlayView.getCropWindowRect());
            float halfWidth = (flipAxes ? com.oguogu.cropper.BitmapUtils.RECT.height() : com.oguogu.cropper.BitmapUtils.RECT.width()) / 2f;
            float halfHeight = (flipAxes ? com.oguogu.cropper.BitmapUtils.RECT.width() : com.oguogu.cropper.BitmapUtils.RECT.height()) / 2f;

            mImageMatrix.invert(mImageInverseMatrix);

            com.oguogu.cropper.BitmapUtils.POINTS[0] = com.oguogu.cropper.BitmapUtils.RECT.centerX();
            com.oguogu.cropper.BitmapUtils.POINTS[1] = com.oguogu.cropper.BitmapUtils.RECT.centerY();
            com.oguogu.cropper.BitmapUtils.POINTS[2] = 0;
            com.oguogu.cropper.BitmapUtils.POINTS[3] = 0;
            com.oguogu.cropper.BitmapUtils.POINTS[4] = 1;
            com.oguogu.cropper.BitmapUtils.POINTS[5] = 0;
            mImageInverseMatrix.mapPoints(com.oguogu.cropper.BitmapUtils.POINTS);
            ...
            mImageMatrix.mapPoints(com.oguogu.cropper.BitmapUtils.POINTS2, com.oguogu.cropper.BitmapUtils.POINTS);
            mZoom /= Math.sqrt(Math.pow(com.oguogu.cropper.BitmapUtils.POINTS2[4] - com.oguogu.cropper.BitmapUtils.POINTS2[2], 2) + Math.pow(com.oguogu.cropper.BitmapUtils.POINTS2[5] - com.oguogu.cropper.BitmapUtils.POINTS2[3], 2));
            ...
            double change = Math.sqrt(Math.pow(com.oguogu.cropper.BitmapUtils.POINTS2[4] - com.oguogu.cropper.BitmapUtils.POINTS2[2], 2) + Math.pow(com.oguogu.cropper.BitmapUtils.POINTS2[5] - com.oguogu.cropper.BitmapUtils.POINTS2[3], 2));
            halfWidth *= change;
            halfHeight *= change;

            // calculate the new crop window rectangle to center in the same location and have proper width/height
            com.oguogu.cropper.BitmapUtils.RECT.set(com.oguogu.cropper.BitmapUtils.POINTS2[0] - halfWidth, com.oguogu.cropper.BitmapUtils.POINTS2[1] - halfHeight,
                    com.oguogu.cropper.BitmapUtils.POINTS2[0] + halfWidth, com.oguogu.cropper.BitmapUtils.POINTS2[1] + halfHeight);

            mCropOverlayView.resetCropOverlayView();
            mCropOverlayView.setCropWindowRect(com.oguogu.cropper.BitmapUtils.RECT);
            applyImageMatrix(getWidth(), getHeight(), true, false);
            handleCropWindowChanged(false, false);
     ...
     */
    void onSetImageUriAsyncComplete(com.oguogu.cropper.BitmapLoadingWorkerTask.Result result) {
     ...
     */
    void onImageCroppingAsyncComplete(com.oguogu.cropper.BitmapCroppingWorkerTask.Result result) {
    ...
    public void startCropWorkerTask(int reqWidth, int reqHeight, RequestSizeOptions options, Uri saveUri, Bitmap.CompressFormat saveCompressFormat, int saveCompressQuality) {
        if (mBitmap != null) {
            ...
            com.oguogu.cropper.BitmapCroppingWorkerTask currentTask = mBitmapCroppingWorkerTask != null ? mBitmapCroppingWorkerTask.get() : null;
            if (currentTask != null) {
            ...
            int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                mBitmapCroppingWorkerTask = new WeakReference<>(new com.oguogu.cropper.BitmapCroppingWorkerTask(this, mLoadedImageUri, getCropPoints(),
                        mDegreesRotated, orgWidth, orgHeight,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        reqWidth, reqHeight, options,
                        saveUri, saveCompressFormat, saveCompressQuality));
            } else {
                mBitmapCroppingWorkerTask = new WeakReference<>(new com.oguogu.cropper.BitmapCroppingWorkerTask(this, mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        reqWidth, reqHeight, options,
                        saveUri, saveCompressFormat, saveCompressQuality));
            }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mLoadedImageUri != null && mBitmap != null) {
            ...
            com.oguogu.cropper.BitmapUtils.mStateBitmap = new Pair<>(key, new WeakReference<>(mBitmap));
            bundle.putString("LOADED_IMAGE_STATE_BITMAP_KEY", key);
        }
        if (mBitmapLoadingWorkerTask != null) {
            com.oguogu.cropper.BitmapLoadingWorkerTask task = mBitmapLoadingWorkerTask.get();
            if (task != null) {
        ...
        mImageMatrix.invert(mImageInverseMatrix);
        mImageInverseMatrix.mapRect(com.oguogu.cropper.BitmapUtils.RECT);

        bundle.putParcelable("CROP_WINDOW_RECT", com.oguogu.cropper.BitmapUtils.RECT);
        ...
        if (state instanceof Bundle) {
            ...
            if (mBitmapLoadingWorkerTask == null && mLoadedImageUri == null && mBitmap == null && mImageResource == 0) {
                ...
                if (uri != null) {
                    ...
                    if (key != null) {
                        Bitmap stateBitmap = com.oguogu.cropper.BitmapUtils.mStateBitmap != null && com.oguogu.cropper.BitmapUtils.mStateBitmap.first.equals(key)
                                ? com.oguogu.cropper.BitmapUtils.mStateBitmap.second.get() : null;
                        if (stateBitmap != null && !stateBitmap.isRecycled()) {
                            com.oguogu.cropper.BitmapUtils.mStateBitmap = null;
                ...
                if (newZoom > 0 && newZoom != mZoom) {
                    if (animate) {
                        if (mAnimation == null) {
                            ...
                            mAnimation = new com.oguogu.cropper.CropImageAnimation(mImageView, mCropOverlayView);
                        }
    ...
    private void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            if (mDegreesRotated > 0) {
                mImageMatrix.postRotate(mDegreesRotated, com.oguogu.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.oguogu.cropper.BitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }

            // scale the image to the image view, image rect transformed to know new width/height
            float scale = Math.min(width / com.oguogu.cropper.BitmapUtils.getRectWidth(mImagePoints), height / com.oguogu.cropper.BitmapUtils.getRectHeight(mImagePoints));
            if (mScaleType == ScaleType.FIT_CENTER || (mScaleType == ScaleType.CENTER_INSIDE && scale < 1) || (scale > 1 && mAutoZoomEnabled)) {
                mImageMatrix.postScale(scale, scale, com.oguogu.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.oguogu.cropper.BitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }

            // scale by the current zoom level
            mImageMatrix.postScale(mZoom, mZoom, com.oguogu.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.oguogu.cropper.BitmapUtils.getRectCenterY(mImagePoints));
            mapImagePointsByImageMatrix();
            ...
            if (center) {
                ...
                mZoomOffsetX = width > com.oguogu.cropper.BitmapUtils.getRectWidth(mImagePoints) ? 0
                        : Math.max(Math.min(width / 2 - cropRect.centerX(), -com.oguogu.cropper.BitmapUtils.getRectLeft(mImagePoints)), getWidth() - com.oguogu.cropper.BitmapUtils.getRectRight(mImagePoints)) / mZoom;
                mZoomOffsetY = height > com.oguogu.cropper.BitmapUtils.getRectHeight(mImagePoints) ? 0
                        : Math.max(Math.min(height / 2 - cropRect.centerY(), -com.oguogu.cropper.BitmapUtils.getRectTop(mImagePoints)), getHeight() - com.oguogu.cropper.BitmapUtils.getRectBottom(mImagePoints)) / mZoom;
            } else {
    ...
    private void updateImageBounds(boolean clear) {
        if (mBitmap != null && !clear) {
            ...
            float scaleFactorWidth = mBitmap.getWidth() * mLoadedSampleSize / com.oguogu.cropper.BitmapUtils.getRectWidth(mImagePoints);
            float scaleFactorHeight = mBitmap.getHeight() * mLoadedSampleSize / com.oguogu.cropper.BitmapUtils.getRectHeight(mImagePoints);
